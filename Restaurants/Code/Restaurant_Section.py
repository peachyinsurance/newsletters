...
def demote_current_winners(newsletter_name: str) -> int:
    """Flip this newsletter's current 'approved' pick (plus any legacy
    Tier 1/2 Winner rows) back to 'approved - old'. Run at the START of each
    pipeline so winners don't pile up across weeks.
