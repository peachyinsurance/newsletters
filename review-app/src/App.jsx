...
export default function PetReviewApp() {
  ...
  return (
    ...
    <div style={{marginBottom: 32}}>
      ...
      <div className="tiles">
        {[
          { label: "Overall", pet: overallWinner, badgeClass: "winner-badge-overall" },
          { label: "Cat",     pet: catWinner,     badgeClass: "winner-badge-cat" },
          { label: "Dog",     pet: dogWinner,     badgeClass: "winner-badge-dog" },
        ].filter(w => w.pet).map(({ label, pet, badgeClass }) => (
